...
CREATE TABLE `players` (
    ...
    `skill_unarmed` int UNSIGNED NOT NULL DEFAULT '10',
    `skill_unarmed_tries` bigint UNSIGNED NOT NULL DEFAULT '0',
    `skill_onehand` int UNSIGNED NOT NULL DEFAULT '10',
    `skill_onehand_tries` bigint UNSIGNED NOT NULL DEFAULT '0',
    `skill_twohand` int UNSIGNED NOT NULL DEFAULT '10',
    `skill_twohand_tries` bigint UNSIGNED NOT NULL DEFAULT '0',
