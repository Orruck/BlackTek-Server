...
function getPlayerDatabaseInfo(name_or_guid)
	...
	local info = {
		...
		["skill_unarmed"] = result.getNumber(query, "skill_unarmed"),
		["skill_onehand"] = result.getNumber(query, "skill_onehand"),
		["skill_twohand"] = result.getNumber(query, "skill_twohand"),
