local showAtkWeaponTypes = {WEAPON_ONEHAND, WEAPON_TWOHAND, WEAPON_DISTANCE}
local showDefWeaponTypes = {WEAPON_ONEHAND, WEAPON_TWOHAND, WEAPON_DISTANCE, WEAPON_SHIELD}
